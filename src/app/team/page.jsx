...
import img1 from "@/../public/assets/team/40.jpg";
import img2 from "@/../public/assets/team/41.jpg"
import img3 from "@/../public/assets/team/forjajf.jpg"
         ...
         <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
            <div className="container p-4 mx-auto space-y-16 sm:p-10">
                ...
                <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-4">
                        <Image src={img2} alt='Taeajdkf'  className="object-cover h-96 mx-auto mb-4 bg-center rounded-sm dark:bg-gray-500"/>
                    ...
                    <div className="space-y-4">
                    <Image src={img1} alt='Taeajdkf'  className="object-cover h-96 mx-auto mb-4 bg-center rounded-sm dark:bg-gray-500"/>
                        <div className="flex flex-col items-center">
                            <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
                            <p className="text-sm dark:text-gray-600">Web developer</p>
                            <div className="flex mt-2 space-x-2">
                    ...
                    <div className="space-y-4">
                    <Image src={img3} alt='Taeajdkf'  className="object-cover h-96 mx-auto mb-4 bg-center rounded-sm dark:bg-gray-500"/>
                        <div className="flex flex-col items-center">
                            <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
                            <p className="text-sm dark:text-gray-600">Web developer</p>
                            <div className="flex mt-2 space-x-2">
