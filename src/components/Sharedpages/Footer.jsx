...
const Footer = () => {
    return (
        <footer className="footer bg-[#F8467E] text-base-content p-10">
        <aside>
          <Image src={imglogo} alt="Logo Image" height={130} width={130} />
          <p>
            SADIA Industries Ltd.
            <br />
        ...
        <nav>
          ...
          <a className="link link-hover">Our Porfolio</a>
          <a className="link link-hover">Term And condition</a>
        </nav>
        <nav>
          <h6 className="footer-title">Quick Links</h6>
          <a className="link link-hover">Quecklinks</a>
